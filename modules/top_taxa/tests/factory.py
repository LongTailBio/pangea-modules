...
from pangea_modules.krakenhll_data.tests.factory import create_result as create_krakenhll
from pangea_modules.metaphlan2_data.tests.factory import create_result as create_metaphlan2
